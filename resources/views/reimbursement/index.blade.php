            ...
            <div class="card mt-4">
                <div class="card-header" style="background-color: maroon; color: #fff;">
                    <div class="d-flex justify-content-between align-items-center w-100">
                        ...
                        <div class="ml-auto">
                            <button class="btn btn-primary" style="background-color: maroon; border-color: maroon;" data-toggle="modal" data-target="#addReimbursementModal">
...
<div class="modal fade" id="addReimbursementModal" tabindex="-1" role="dialog" aria-labelledby="addReimbursementModalLabel" aria-hidden="true">
            ...
            <form action="{{ route('reimbursement.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered mb-0" id="modalExpenseTable" style="border-color: maroon;">
                                <thead style="background-color: maroon; color: #fff;">
                                    <tr>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="number" name="expense_amount[]" class="form-control" required onkeyup="calculateModalTotal();">
                                        </td>
                                        <td>
                                            <button type="button" class="btn btn-danger btn-sm" onclick="delModalRow(this)"><i class="fa fa-minus"></i></button>
                                        </td>
                                    </tr>
                                </tbody>
                                <tfoot>
                                    <tr>
                                        <td colspan="2">
                                            <button type="button" class="btn btn-primary btn-sm" onclick="addModalRow()"><i class="fa fa-plus"></i> Add Row</button>
                                        </td>
                                        <td colspan="2">
